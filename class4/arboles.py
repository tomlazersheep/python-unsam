...
# Usando tu trabajo en el Ejercicio 3.19, generá un
# histograma con las alturas de los Jacarandás en el dataset.
...
plt.hist(jacarandaHeights, bins=30)
plt.show()


# Ejercicio 4.31: Scatterplot(diámetro vs alto) de Jacarandás

# Usando como base tu trabajo del Ejercicio 3.20, vas a generar
# un scatterplot para visualizar la relación entre diámetro y alto
# de los Jacarandás del dataset.

# jacarandaData tiene tuplas con [(alto, diametro),...]


plt.scatter(jacarandaHeights, jacarandaDiameters)
