...
arg = [1, 2, 3, 5, 6, 7, 8, 9, 123, 234, 3456]
print(
    f"busqueda_lineal_lordenada({arg},4)-->{busqueda_lineal_lordenada(arg,4)}",)

print(
    f"busqueda_lineal_lordenada({arg},9)-->{busqueda_lineal_lordenada(arg,9)}",)